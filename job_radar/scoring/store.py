...
def save_rubric(
    *,
    ...
    location_policy: str = "flexible",
    remote_policy: str = "any_remote",
    unknown_location_policy: str = "keep",
    ...
    rubric = ScoringRubric(
        ...
        unknown_location_policy=unknown_location_policy,
...
def active_rubric_values() -> dict[str, str]:
    ...
    return {
        ...
        "location_policy": rubric.location_policy,
        "remote_policy": rubric.remote_policy,
        "unknown_location_policy": rubric.unknown_location_policy,
